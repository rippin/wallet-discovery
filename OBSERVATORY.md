...
2. Copy `.env.observatory.example` to `.env.observatory`. Set `HELIUS_API_KEY` and a unique `OBS_PASSWORD` of at least 20 characters locally on the VPS. Set `OBS_LIVE=1`. Keep this file permissioned `600` and out of Git.
